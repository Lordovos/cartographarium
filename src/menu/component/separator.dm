obj/menu/separator
	...
	New(loc, ident, obj/menu/parent, vector/position = vector(0, 0), vector/offset = vector(0, 0), vector/size = vector(src.width, src.height), orientation = src.orientation)
		src.ident = ident
